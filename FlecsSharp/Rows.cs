...
namespace FlecsSharp
{
    ...
    unsafe partial struct Rows
    {
        ...
        public IntPtr Table
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => table;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => table = value;
        }

        public IntPtr TableColumns
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => tableColumns;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => tableColumns = value;
        }
        ...
        public IntPtr Param
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => param;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => param = value;
        }

        public float DeltaTime
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => deltaTime;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => deltaTime = value;
        }

        public float WorldTime
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => worldTime;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => worldTime = value;
        }

        public uint FrameOffset
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => frameOffset;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => frameOffset = value;
        }

        public uint Offset
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => offset;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => offset = value;
        }
