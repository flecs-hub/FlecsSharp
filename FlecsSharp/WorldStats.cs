...
namespace FlecsSharp
{
    unsafe partial struct WorldStats
    {
        ...
        public Vector Features
        {
            ...
            get => ptr->features;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->features = value; }
        }

        public Vector OnLoadSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onLoadSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onLoadSystems = value; }
        }

        public Vector PostLoadSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->postLoadSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->postLoadSystems = value; }
        }

        public Vector PreUpdateSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->preUpdateSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->preUpdateSystems = value; }
        }

        public Vector OnUpdateSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onUpdateSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onUpdateSystems = value; }
        }

        public Vector OnValidateSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onValidateSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onValidateSystems = value; }
        }

        public Vector PostUpdateSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->postUpdateSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->postUpdateSystems = value; }
        }

        public Vector PreStoreSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->preStoreSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->preStoreSystems = value; }
        }

        public Vector OnStoreSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onStoreSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onStoreSystems = value; }
        }
        ...
        public Vector TaskSystems
        {
            ...
            get => ptr->taskSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->taskSystems = value; }
        }

        public Vector InactiveSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->inactiveSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->inactiveSystems = value; }
        }

        public Vector OnDemandSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onDemandSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onDemandSystems = value; }
        }

        public Vector OnAddSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onAddSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onAddSystems = value; }
        }

        public Vector OnRemoveSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onRemoveSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onRemoveSystems = value; }
        }

        public Vector OnSetSystems
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->onSetSystems;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->onSetSystems = value; }
        }
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->frameProfiling;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->frameProfiling = value; }
        }

        public bool SystemProfiling
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ptr->systemProfiling;
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            //set => ptr->systemProfiling = value; }
        }
