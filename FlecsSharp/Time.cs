...
namespace FlecsSharp
{
    ...
    unsafe partial struct Time
    {
        public int Sec
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => sec;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => sec = value;
        }

        public uint Nanosec
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => nanosec;
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => nanosec = value;
        }
